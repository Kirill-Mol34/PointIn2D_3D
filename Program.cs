...
int numAxes = 3;            // оси координат, меняя значение на 2 мы будем определять в 2D.
int min = -20;               
int max = 20;               

int[] PointCoords(int numAxes)                  
{
    int[] coords = new int[numAxes];
...
int[] PointA = PointCoords(numAxes);
int[] PointB = PointCoords(numAxes);
